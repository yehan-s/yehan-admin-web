...
import { Row, Col, Tooltip, Divider, Select, Dropdown } from 'antd'
import { CaretDownOutlined, CaretUpOutlined, DashOutlined, InfoCircleOutlined } from '@ant-design/icons'
    ...
    <>
      <Row gutter={[16, 16]}>
        <Col lg={24} xl={8} className="w-full">
          <div className="color-transparent dark:bg-[rgb(33,41,79)] w-full bg-[rgb(94,53,177)] overflow-hidden relative h-[241px] rounded-md bg-card p-[32px] box-border">
            <div className="absolute top-[24px] right-[24px] z-10">
              <Tooltip title={t("zhFeEHKg" /* 指标说明 */)}>
                <InfoCircleOutlined className="text-[rgb(179,157,219)] text-[20px]" />
              </Tooltip>
              <div className="text-[rgba(229,224,246,0.45)] text-[16px]">{t("RHAgXvIt" /* 总销售额 */)}</div>
              <div className="text-white text-2xl mt-[28px] text-[30px]">¥ 126,560</div>
              <div className="mt-[50px] text-[rgba(229,224,216,0.85)] text-[16px] flex gap-[24px]">
                <div className="flex items-center">
                  <span>{t("utwLpepv" /* 周同比 */)}</span>
                  <span className="ml-[12px]">12%</span>
                  <CaretDownOutlined className="ml-[6px] text-red-500" />
                </div>
                <div className="flex items-center">
                  <span>{t("jsAsJlka" /* 日同比 */)}</span>
                  <span className="ml-[12px]">12%</span>
                  <CaretDownOutlined className="ml-[6px] text-green-500" />
                </div>
              </div>
        ...
        <Col lg={24} xl={8} className="w-full">
          <div className="color-transition dark:bg-[rgb(33,41,70)] bg-[rgb(30,136,229)] theme1 overflow-hidden h-[241px] relative rounded-md bg-card p-[32px] box-border">
            <div className="absolute top-[24px] right-[24px] z-10">
              <Tooltip title={t("hOrhjVJh" /* 指标说明 */)}>
                <InfoCircleOutlined className="text-[rgb(179,157,219)] text-[20px]" />
              </Tooltip>
            </div>
            <div className="text-[rgba(229,224,216,0.45)] text-[16px]">{t("jVSIaUEJ" /* 访问量 */)}</div>
        ...
        <Col lg={24} xl={8} className="w-full">
          <div className="color-transition dark:bg-[rgb(33,41,70)] bg-[rgb(94,53,177)] theme2 overflow-hidden h-[241px] relative rounded-md bg-card p-[32px] box-border">
            <div className="absolute top-[24px] right-[24px] z-10">
              <Tooltip title={t("HashxhbF" /* 指标说明 */)}>
                <InfoCircleOutlined className="text-[rgb(179,157,219)] text-[20px]" />
              </Tooltip>
            </div>
            <div className="text-[rgba(229,224,216,0.45)] text-[16px]">{t("rgXvbcRA" /* 支付笔数 */)}</div>
        ...
        <Col lg={24} xl={8} className="w-full">
          <div className="color-transition dark:bg-[rgb(33,41,70)] bg-white h-[600px] rounded-md p-[24px] relative">
            <div className="flex justify-between">
              <span className="dark:text-[rgb(215,220,236)] text-[18px] text-[rgb(18,25,38)]">{t("KErfyJtB" /* 门店销售额 */)}</span>
              <Dropdown
                menu={{
                  items: [
                    {
            ...
            <div className="dark:bg-[rgb(209,196,233)] bg-[rgb(237,231,246)] px-[16px] pt-[16px] mt-[24px] rounded-t-lg">
              <div className="flex justify-between items-center">
                <span className="text-[rgb(101,31,255)] text-[16px]">{t("SKyEGXwO" /* 上海分店 */)}</span>
            ...
            <div className="py-[24px]">
              <div>
                <div className="flex justify-between items-center">
                  <span className="dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">{t("IRaXfygi" /* 上海分店 */)}</span>
                  <div>
                ...
                <div className="text-[rgb(0,200,83)] text-[12px] mt-[6px]">{t("qNDpzfpD" /* 20% 利润 */)}</div>
              </div>
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[16px]" />
              <div>
                <div className="flex justify-between items-center">
                  <span className="dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)]font-medium">{t("FjMBvZxO" /* 合肥分店 */)}</span>
                  <div>
                    <span className="mr-[8px] dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">
                      ￥10,000
                    </span>
                ...
                <div className="text-[rgb(0,200,83)] text-[12px] mt-[6px]">{t("ksenMMld" /* 6% 利润 */)}</div>
              </div>
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[16px]" />
              <div>
                <div className="flex justify-between items-center">
                  <span className="dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">{t("AeEvDZEy" /* 北京分店 */)}</span>
                  <div>
                    <span className="mr-[8px] dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">
                      ￥8,000
                    </span>
                ...
                <div className="text-[rgb(216,67,21)] text-[12px] mt-[6px]">{t("mvZsNXqP" /* 8% 亏损 */)}</div>
              </div>
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[16px]" />
              <div>
                <div className="flex justify-between items-center">
                  <span className="dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">{t("oVErMtOk" /* 苏州分店 */)}</span>
                  <div>
                    <span className="mr-[8px] dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">
                      ￥9,423
                    </span>
                ...
                <div className="text-[rgb(0,200,83)] text-[12px] mt-[6px]">{t("CXetHddn" /* 14% 利润 */)}</div>
              </div>
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[16px]" />
              <div>
                <div className="flex justify-between items-center">
                  <span className="dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">{t("SlybHQgQ" /* 南京分店 */)}</span>
                  <div>
                    <span className="mr-[8px] dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)] font-medium">
                      ￥7,423
                    </span>
                ...
                <div className=" text-[12px] mt-[6px] text-[rgb(216,67,21)]"> {t("wkLHQUwH" /* 6% 亏损 */)}</div>
              </div>
            </div>
          </div>
        </Col>
